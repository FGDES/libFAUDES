...
PREPARETARGETS = $(FILE_CONFIG) includes VERSION.bat
...
VERSION.bat: VERSION
	echo "REM autogenerated to set version in command.com batch file." > VERSION.bat
	echo set FAUDES_VERSION_MAJOR=$(FAUDES_VERSION_MAJOR) >> VERSION.bat
	echo set FAUDES_VERSION_MINOR=$(FAUDES_VERSION_MINOR) >> VERSION.bat
