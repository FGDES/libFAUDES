...
function lua2ref(fname, outfnc)
  ...
  outfnc('respective plug-in and invoke <tt>luafaudes<tt> with argument <tt>' .. bname .. '</tt> ')
  outfnc('from the command prompt.\n')
  outfnc('The script expects its input data at <tt>./tutorial/data/</tt> and ')
  outfnc('writes its output to <tt>./tutorial/tmp_*</tt>\n')
  outfnc('</p>\n')
